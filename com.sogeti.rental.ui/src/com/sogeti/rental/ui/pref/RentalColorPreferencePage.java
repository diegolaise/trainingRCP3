...
public class RentalColorPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage, RentalUIConstants{
	...
	public void createFieldEditors() {
		addField(new ColorFieldEditor(PREF_CUSTOMER_COLOR, 
				"&Customer :", getFieldEditorParent())); 
		addField(new ColorFieldEditor(PREF_RENTAL_COLOR, 
				"&Rental :", getFieldEditorParent()));
		addField(new ColorFieldEditor(PREF_OBJECT_COLOR, 
				"&Objects :", getFieldEditorParent()));
	}
